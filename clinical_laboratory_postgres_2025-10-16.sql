...
\restrict oHN2vS8dcZEDfTMrgoyf48OKsgQH19gmzHSh1RTnMd6nXlUSdIiwWTetDzDhggT

-- Dumped from database version 16.10 (Debian 16.10-1.pgdg13+1)
-- Dumped by pg_dump version 16.10 (Debian 16.10-1.pgdg13+1)

-- Started on 2025-10-16 10:42:20 UTC
...
9	Donna	Miller	Oncology	+1-3900-715-4629	dr.donna.miller9@clinic.org
...
9	Carol	Lee	ID20250009	1950-01-07	M	535 Birch Ave., Georgetown, PA 18675	+1-3900-416-6155	carol.lee9@example.com
10	Susan	Adams	ID20250010	1989-10-15	F	7527 Pine Rd., Lakeside, FL 42325	+1-3010-962-9830	susan.adams10@example.com
...
1	1	119.23	2023-12-27 16:01:00	Cash	Completed
...
SELECT pg_catalog.setval('public.doctors_audit_audit_id_seq', 1, true);
...
--
-- TOC entry 3521 (class 2620 OID 139286)
...
--
-- TOC entry 3524 (class 2620 OID 139346)
...
--
-- TOC entry 3518 (class 2620 OID 139316)
...
--
-- TOC entry 3530 (class 2620 OID 139436)
...
--
-- TOC entry 3533 (class 2620 OID 139406)
...
--
-- TOC entry 3527 (class 2620 OID 139376)
...
--
-- TOC entry 3522 (class 2620 OID 139287)
...
--
-- TOC entry 3525 (class 2620 OID 139347)
...
--
-- TOC entry 3519 (class 2620 OID 139317)
...
--
-- TOC entry 3531 (class 2620 OID 139437)
...
--
-- TOC entry 3534 (class 2620 OID 139407)
...
--
-- TOC entry 3528 (class 2620 OID 139377)
...
--
-- TOC entry 3523 (class 2620 OID 139288)
-- Name: doctors bd_doctors_audit; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3526 (class 2620 OID 139348)
-- Name: lab_orders bd_lab_orders_audit; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER bd_lab_orders_audit BEFORE DELETE ON public.lab_orders FOR EACH ROW EXECUTE FUNCTION public.lab_orders_bd_audit();
...
--
-- TOC entry 3520 (class 2620 OID 139318)
-- Name: patients bd_patients_audit; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3532 (class 2620 OID 139438)
-- Name: payments bd_payments_audit; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3535 (class 2620 OID 139408)
-- Name: results bd_results_audit; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER bd_results_audit BEFORE DELETE ON public.results FOR EACH ROW EXECUTE FUNCTION public.results_bd_audit();
...
--
-- TOC entry 3529 (class 2620 OID 139378)
-- Name: samples bd_samples_audit; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER bd_samples_audit BEFORE DELETE ON public.samples FOR EACH ROW EXECUTE FUNCTION public.samples_bd_audit();
...
-- Completed on 2025-10-16 10:42:20 UTC

--
-- PostgreSQL database dump complete
--

\unrestrict oHN2vS8dcZEDfTMrgoyf48OKsgQH19gmzHSh1RTnMd6nXlUSdIiwWTetDzDhggT
